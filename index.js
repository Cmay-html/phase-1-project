...
const BASE_URL = "https://phase-1-project-4-l7y8.onrender.com";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  newForm.addEventListener("submit", function (e) {
    ...
    const newPark = {
      ...
      images: newForm.images.value ? newForm.images.value.split(",").map((i) => i.trim()) : [],
    };
